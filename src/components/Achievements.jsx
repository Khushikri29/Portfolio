...
const Achievements = () => {
  const achievements = [
    ...
    {
      title: "📄 Research Publication",
      desc: 'Published paper: "An Edge-AI Based IoT System for Multi-Crop Monitoring and Intelligent Farming"',
  ...
  return (
    <section id="achievements" style={{ backgroundColor: 'var(--bg-primary)' }}>
      <div className="container">
        <h2 className="section-title serif reveal-hidden">
        ...
        <div className="ach-grid">
          {achievements.map((ach, idx) =>
            ach.type === 'stat' ? (
              <div
                key={idx}
                className="stat-card reveal-hidden"
              ...
              <div
                key={idx}
                className="ach-card reveal-hidden"
                style={{ transitionDelay: `${idx * 150}ms` }}
              >
