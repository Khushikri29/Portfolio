      ...
      <div className="container">
        <div className="contact-container">
          <div className="contact-info reveal-hidden">
            <h2 className="serif" style={{ fontSize: '2.5rem', marginBottom: '1rem', color: 'var(--text-primary)' }}>Let's work together</h2>
            <p style={{ marginBottom: '3rem', color: 'var(--text-secondary)' }}>I'd love to hear about your project, idea, or opportunity. Drop me a message!</p>
            <div className="contact-links">
              <a href="mailto:khushikumari201280@gmail.com" className="contact-link">
                <i className="fa-regular fa-envelope" style={{ color: 'var(--accent)' }}></i> Email Me
              </a>
              <a href="https://github.com/Khushikri29" target="_blank" rel="noopener noreferrer" className="contact-link">
                <i className="fa-brands fa-github" style={{ color: 'var(--accent)' }}></i> GitHub
              </a>
              <a href="https://www.linkedin.com/in/khushi-kumari-56ab83271/" target="_blank" rel="noopener noreferrer" className="contact-link">
                <i className="fa-brands fa-linkedin" style={{ color: 'var(--accent)' }}></i> LinkedIn
              </a>
            </div>
          </div>
